...
public class PPGSensor extends SurfaceView implements Callback, Camera.PreviewCallback {
     ...
     * {@link PPGSensor} instance that has not yet been completely initialized.
    ...
    private static final String TAG = PPGSensor.class.getName();
    ...
    public PPGSensor(Context context, AttributeSet attrs) {
        super(context, attrs);
